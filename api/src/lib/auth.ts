/**
 * NOTE: this file was autogenerated by `yarn rw setup auth custom`.
 * As of now, nothing is actually used since we haven't tried to integrate auth with GQL
 * (and may never try since it's less important in an SSR world).
 * It's kept as is so potential future GQL-integration efforts will have something to start with.
 */
